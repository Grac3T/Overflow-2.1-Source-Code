...
import net.minecraft.server.v1_8_R1.EnumAnimation;
...
public class BlockBox1_8_R1 implements BlockBox
{
    public List<BoundingBox> getCollidingBoxes(final World world, final BoundingBox box) {
                ...
                for (int y = minY - 1; y < maxY; ++y) {
                    ...
                    if (block != null && !block.getType().equals((Object)Material.AIR)) {
                        if (BlockUtil.collisionBoundingBoxes.containsKey(block.getType())) {
                            ...
                            final net.minecraft.server.v1_8_R1.Block nmsBlock = nmsiBlockData.getBlock();
        ...
        aabbs.stream().filter(Objects::nonNull).forEach(BlockBox1_8_R1::lambda$getCollidingBoxes$0);
        return boxes;
    }
    ...
    public boolean isChunkLoaded(final Location loc) {
        final net.minecraft.server.v1_8_R1.World world = (net.minecraft.server.v1_8_R1.World)((CraftWorld)loc.getWorld()).getHandle();
